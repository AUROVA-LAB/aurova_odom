...
#define LASER_CELL_WIDTH 200.0
#define LASER_CELL_HEIGHT 200.0
#define LASER_CELL_DEPTH 200.0

//separate map as many sub point clouds

#define LASER_CELL_RANGE_HORIZONTAL 20
#define LASER_CELL_RANGE_VERTICAL 20
